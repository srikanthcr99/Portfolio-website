(function($) {
    ...
    //On Click Open work Block
    $('.work-block, .menu-item.work').on('click', function() {
        $('.content-blocks').removeClass('showx');
        $('.content-blocks.work').addClass('showx');
        $('.menu-item').removeClass('active');
        $('.menu-item.work').addClass('active');
    });
    ...
    //On Click Close work Post And Project Details
